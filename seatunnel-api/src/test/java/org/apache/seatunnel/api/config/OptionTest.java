...
public class OptionTest {
    public static final ConfigEntry<Integer> TEST_NUM =
            ConfigOption.key("option.num")
                    .intType()
                    .defaultValue(100)
                    .withDescription("test int option");

    public static final ConfigEntry<TestMode> TEST_MODE =
            ConfigOption.key("option.mode")
    ...
    public void testEquals() {
        Assertions.assertEquals(
                TEST_NUM, ConfigOption.key("option.num").intType().defaultValue(100));
        Assertions.assertEquals(
                TEST_MODE,
                ConfigOption.key("option.mode")
                        .enumType(TestMode.class)
