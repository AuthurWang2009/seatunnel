...
public class ConfigUtil {
    ...
    public static <T> T convertValue(Object rawValue, ConfigEntry<T> option) {
    ...
    public static <T> List<T> convertToList(Object rawValue, Class<T> clazz) {
    ...
    @SuppressWarnings("unchecked")
    public static <T> T convertValue(Object rawValue, Class<T> clazz) {
