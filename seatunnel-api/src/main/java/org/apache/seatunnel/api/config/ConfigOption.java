...
public class ConfigOption {
    ...
    /**
     * Starts building a new {@link ConfigEntry}.
     *
    ...
    /**
     * The option builder is used to create a {@link ConfigEntry}. It is instantiated via {@link
    ...
    /**
     * Builder for {@link ConfigEntry} with a defined atomic type.
     *
    ...
    public static class TypedOptionBuilder<T> {
         ...
         */
        public ConfigEntry<T> defaultValue(T value) {
            return new ConfigEntry<>(key, typeReference, value);
        }
         ...
         */
        public ConfigEntry<T> noDefaultValue() {
            return new ConfigEntry<>(key, typeReference, null);
        }
    }
    ...
    public static class SingleChoiceOptionBuilder<T> {
         ...
         * @return The config option with the default value.
         */
        public SingleChoiceConfigEntry<T> defaultValue(T value) {
            return new SingleChoiceConfigEntry<T>(key, typeReference, optionValues, value);
        }
         ...
         * @return The config option without a default value.
         */
        public SingleChoiceConfigEntry<T> noDefaultValue() {
            return new SingleChoiceConfigEntry<T>(key, typeReference, optionValues, null);
        }
    }
}
