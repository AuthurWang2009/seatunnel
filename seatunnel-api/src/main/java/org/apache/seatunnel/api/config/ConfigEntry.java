...
public class ConfigEntry<T> {
    ...
    public ConfigEntry(String key, TypeReference<T> typeReference, T defaultValue) {
        this.key = key;
    ...
    public ConfigEntry<T> withDescription(String description) {
        this.description = description;
        return this;
    }

    public ConfigEntry<T> withFallbackKeys(String... fallbackKeys) {
