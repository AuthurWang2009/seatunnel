...
public class OptionUtil {
    ...
    public static String getOptionKeys(List<ConfigEntry<?>> options) {
    ...
    public static String getOptionKeys(
            List<ConfigEntry<?>> options,
            List<RequiredOption.BundledRequiredOptions> bundledOptions) {
        List<List<ConfigEntry<?>>> optionList = new ArrayList<>();
        for (ConfigEntry<?> option : options) {
        ...
        boolean flag = false;
        StringBuilder builder = new StringBuilder();
        for (List<ConfigEntry<?>> optionSet : optionList) {
            if (flag) {
                builder.append(", ");
            }
    ...
    public static List<ConfigEntry<?>> getOptions(Class<?> clazz)
            throws InstantiationException, IllegalAccessException {
        Field[] fields = clazz.getDeclaredFields();
        List<ConfigEntry<?>> options = new ArrayList<>();
