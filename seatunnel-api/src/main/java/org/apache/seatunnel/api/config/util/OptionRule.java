...
/**
 * Validation rule for {@link ConfigEntry}.
 *
...
public class OptionRule {
     ...
     */
    private final List<ConfigEntry<?>> optionalOptions;
    ...
    OptionRule(List<ConfigEntry<?>> optionalOptions, List<RequiredOption> requiredOptions) {
        this.optionalOptions = optionalOptions;
        this.requiredOptions = requiredOptions;
    }

    public List<ConfigEntry<?>> getOptionalOptions() {
    ...
    public static class Builder {
        private final List<ConfigEntry<?>> optionalOptions = new ArrayList<>();
         ...
         * <p>This is used by the web-UI to show what options are available.
         */
        public Builder optional(@NonNull ConfigEntry<?>... options) {
        ...
        public Builder required(@NonNull ConfigEntry<?>... options) {
        ...
        public Builder exclusive(@NonNull ConfigEntry<?>... options) {
            if (options.length <= 1) {
        ...
        public <T> Builder conditional(
                @NonNull ConfigEntry<T> conditionalOption,
                @NonNull List<T> expectValues,
                @NonNull ConfigEntry<?>... requiredOptions) {
        ...
        public Builder bundled(@NonNull ConfigEntry<?>... requiredOptions) {
        ...
        private void verifyRequiredOptionDefaultValue(@NonNull ConfigEntry<?> option) {
        ...
        private void verifyDuplicateWithOptionOptions(
                @NonNull ConfigEntry<?> option, @NonNull String currentOptionType) {
                                        ...
                                        ro -> {
                                            if (ro
                                                    ...
                                                    && requiredOption
                                                            ...
                                                            RequiredOption
                                                                    .ConditionalRequiredOptions) {
                                                ConfigEntry<?> requiredOptionCondition =
        ...
        private void verifyConditionalExists(@NonNull ConfigEntry<?> option) {
