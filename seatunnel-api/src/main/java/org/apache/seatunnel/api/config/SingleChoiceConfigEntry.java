...
public class SingleChoiceConfigEntry<T> extends ConfigEntry<T> {

    @Getter private final List<T> optionValues;

    public SingleChoiceConfigEntry(
    ...
    @Override
    public SingleChoiceConfigEntry<T> withDescription(String description) {
