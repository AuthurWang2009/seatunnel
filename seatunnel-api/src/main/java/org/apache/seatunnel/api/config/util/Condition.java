...
public class Condition<T> {
    private final ConfigEntry<T> option;
    private final T expectValue;
    private Boolean and = null;
    private Condition<?> next = null;

    Condition(ConfigEntry<T> option, T expectValue) {
        this.option = option;
        this.expectValue = expectValue;
    }

    public static <T> Condition<T> of(ConfigEntry<T> option, T expectValue) {
        return new Condition<>(option, expectValue);
    }

    public <E> Condition<T> and(ConfigEntry<E> option, E expectValue) {
        return and(of(option, expectValue));
    }

    public <E> Condition<T> or(ConfigEntry<E> option, E expectValue) {
    ...
    public ConfigEntry<T> getOption() {
        return option;
    }
